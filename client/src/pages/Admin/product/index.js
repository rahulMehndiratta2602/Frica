...
const Products = () => {
    ...
    return (
        <div className="w-full relative h-full bg-primary flex flex-col px-2 sm:px-4 pt-3 pb-3 border-light sm:border-[12px] rounded-md space-y-1 overflow-hidden text-center">
