    ...
    return (
        ...
        >
            ...
            <input
                ...
                value={password}
            />
            <button type="submit" className="bg-secondary px-4 py-2 text-lg rounded-full hover:opacity-90 text-white hover:text-white border-b-2 border-r-[1px] border-light  hover:border-r-2 hover:translate-x-[-1px] hover:translate-y-[-2px] focus:outline-none focus:ring-1 focus:ring-lightest">Complete Registration</button>
        </form>
