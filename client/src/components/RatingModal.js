...
const RatingModal = ({ setShowModal, handleOk, review }) => {
    ...
    return (
        <div className={`z-50 absolute left-0 w-[100vw] overflow-hidden h-screen bg-slate-900 bg-opacity-80 flex justify-center items-center`
            ...
            <div className="bg-white py-10 md:w-[40vw] relative items-center space-y-2 w-60 flex flex-col rounded-md">
                ...
                <div className="relative w-full px-4 pt-4">
                    ...
                    <textarea
                        ...
                        name="review"
                        id="review"
                        className="bg-slate-100 px-2 scrollhost overflow-y-scroll w-full h-[300px] md:h-[200px]
                ...
                <button className=' py-1 px-4 bg-primary text-white rounded-sm !mt-4 hover:opacity-60' onClick={() => {
                    review !== null ? handleOk(rating, reviewText, 'PATCH') : handleOk(rating, reviewText, 'POST')
                    closeModal()
